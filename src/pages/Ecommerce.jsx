...
const Ecommerce = () => {
    ...
    return (
        <div className="mt-24">
            <div className='flex  flex-wrap md:flex-col lg:flex-nowrap lg:flex-row justify-center'>
                ...
                lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
                    <div className='flex justify-between items-center'>
                        <div>
                            <p className='font-bold text-blue-400'>Earnings</p>
                            <p className='text-2xl text-blue-200'>$63,525.88</p>
                        </div>
                        <button
                            type='button'
                ...
                <div className='flex m-3 flex-wrap justify-center gap-1 items-center'>
                    {earningData.map((item) => (
                        <div key={item.title} className='bg-white dark:text-gray-200
                            dark:bg-secondary-dark-bg p-4 pt-9 rounded-2xl md:w-56'>
                ...
                rounded-2xl m-3 p-4 md:w-780">
                    ...
                    <div className='mt-10 flex gap-10 flex-wrap justify-center'>
                        <div className='border-r-1 border-color mt-4 pr-10'>
                            <div>
                                <p>
                                    <span className='text-3xl font-semibold'>$93,444</span>
                                    <span className='p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full
                                        text-white text-xs ml-3 bg-green-400
                                    '>23%</span>
                                </p>
                            ...
                            <div className='mt-8'>
                                <p>
                                    <span className='text-3xl font-semibold'>$42,444</span>
                                </p>
                                <p className='text-gray-500 mt-1'>
                                    Expense
                                </p>
